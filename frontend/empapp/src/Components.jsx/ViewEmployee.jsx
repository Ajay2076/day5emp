...
const ViewEmployee = () => {
  ...
  return (
    <div style={{paddingTop:"80px"}}>
       ...
       <TableHead>
           <TableRow>
               <TableCell>Employee_Name</TableCell><br></br>
               <TableCell>Employee_Age</TableCell><br></br>
               <TableCell>Employee_Position</TableCell><br></br>
               <TableCell>Employee_Salary</TableCell><br></br>
           </TableRow>
       </TableHead>
       <TableBody>
           {users.map((val,i)=>{
